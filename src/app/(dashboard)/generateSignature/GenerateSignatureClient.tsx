        ...
        >
            ...
            >
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Button size="sm" className={`cursor-pointer ${currentTemplatesCategory === "horizontal" ? "bg-[#dee7ff] border-black border-[1px] text-black hover:bg-[#c8cfe7]" : "bg-black"}`} onClick={() => setCurrentTemplateCategory("horizontal")}>
                        Horizontal
                    ...
                    <Button size="sm" className={`cursor-pointer ${currentTemplatesCategory === "vertical" ? "bg-[#dee7ff] border-black border-[1px] text-black hover:bg-[#c8cfe7]" : "bg-black"}`} onClick={() => setCurrentTemplateCategory("vertical")}>
                        Vertical
